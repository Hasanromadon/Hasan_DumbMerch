            ...
            <Row className="g-0">
              <Col md={12} className="">
                <div className="messages-container">
                  <div className=" message-right-container ms-auto mb-2">
                    <div className="d-flex">
                      <div className="p-2 rounded">
                        <p className="m-0">
                          Hello Admin, I need your help! I need your help! I
                          need your help!{' '}
                        </p>
                        <div className="position-absolute polygon-chat-right">
                          <img src="/assets/icons/poligon-right.svg" alt="" />
                        </div>
                      </div>
                    </div>
                  </div>
